...
% pP
dC(1) = theta(1) - theta(2)*C(1) + theta(3)*EL;
...
% mPRR9
dC(4) = theta(9)*C(3)^(theta(10)) - theta(11)*C(4) + theta(12)*C(1)*EL; 
...
% pGI
dC(22) = theta(62)*C(21) - theta(63)*C(22) - theta(64)*C(16)*C(23)*C(22)  ; 
